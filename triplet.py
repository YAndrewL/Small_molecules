# -*- coding: utf-8 -*-
# @Time         : 2022/12/22 15:09
# @Author       : Yufan Liu
# @Description  : Classification with cross-entropy guided triplet loss
...
from model import StageMLP, ContinueModel, CNNOD, RNN, TransformerModel
...
class TripletClassificationModel(pl.LightningModule):
    def __init__(self,
        ...
        assert backbone in ['stage', 'full', 'cnn', 'rnn', 'attention'], 'Not support.'
...
if __name__ == '__main__':
    ...
    data_params = {'batch_size': batch_size, 
                    'train_data_root': './Dataset/SM/esm_scpdb.pkl',
                    'val_data_root': './Dataset/SM/esm_joined.pkl'}
    samples_per_class = [1665261, 72579]
